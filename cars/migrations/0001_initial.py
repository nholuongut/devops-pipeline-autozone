# Generated by Django 3.0.7 on 2023-04-12 00:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('N0', 'Carlow'), ('N1', 'Cavan'), ('N2', 'Clare'), ('N3', 'Cork'), ('N4', 'Donegal'), ('N5', 'Dublin'), ('N6', 'Galway'), ('N8', 'Kerry'), ('N9', 'Kildare'), ('NA', 'Kilkenny'), ('NG', 'Laois'), ('NI', 'Leitrim'), ('NK', 'Limerick'), ('NL', 'Longford'), ('NM', 'Louth'), ('NN', 'Mayo'), ('NO', 'Meath'), ('NP', 'Monaghan'), ('NQ', 'Offaly'), ('NR', 'Roscommon'), ('NW', 'Sligo'), ('NX', 'Tipperary NR'), ('NY', 'Tipperary SR'), ('NZ', 'Waterford'), ('10', 'Westmeath'), ('11', 'Wexford'), ('12', 'Wicklow')], max_length=100)),
